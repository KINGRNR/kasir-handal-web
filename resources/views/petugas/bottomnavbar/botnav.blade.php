{{-- <nav class="navbar navbar-dark bg-white navbar-expand fixed-bottom d-lg-none d-xl-none">
    <ul class="navbar-nav nav-justified w-100">
        ...
        <li class="nav-item">
            <a href="/petugas/petugas" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <g clip-path="url(#clip0_44_6933)">
                      <path d="M16 11C17.66 11 18.99 9.66 18.99 8C18.99 6.34 17.66 5 16 5C14.34 5 13 6.34 13 8C13 9.66 14.34 11 16 11ZM8 11C9.66 11 10.99 9.66 10.99 8C10.99 6.34 9.66 5 8 5C6.34 5 5 6.34 5 8C5 9.66 6.34 11 8 11ZM8 13C5.67 13 1 14.17 1 16.5V18C1 18.55 1.45 19 2 19H14C14.55 19 15 18.55 15 18V16.5C15 14.17 10.33 13 8 13ZM16 13C15.71 13 15.38 13.02 15.03 13.05C15.05 13.06 15.06 13.08 15.07 13.09C16.21 13.92 17 15.03 17 16.5V18C17 18.35 16.93 18.69 16.82 19H22C22.55 19 23 18.55 23 18V16.5C23 14.17 18.33 13 16 13Z" fill="#323232"/>
                    </g>
                    <defs>
                      <clipPath id="clip0_44_6933">
                        <rect width="24" height="24" fill="white"/>
                      </clipPath>
                    </defs>
                  </svg>
        ...
        <li class="nav-item">
            <a href="/petugas/kategori" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none">
                    <g clip-path="url(#clip0_44_5604)">
                        <path
                            d="M11.15 3.40004L7.43 9.48004C7.02 10.14 7.5 11 8.28 11H15.71C16.49 11 16.97 10.14 16.56 9.48004L12.85 3.40004C12.46 2.76004 11.54 2.76004 11.15 3.40004Z"
                            fill="#323232" />
                        <path
        ...
        <li class="nav-item">
            <a href="/petugas/keranjang" class="nav-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                    fill="none">
                    <g clip-path="url(#clip0_44_8113)">
                        <path
