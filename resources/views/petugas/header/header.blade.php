                         ...
                         <div
                             ...
                             <div onclick="window.location.href='/petugas/kategori'" class="menu-item me-lg-1">
                                 <span class="menu-link py-3 kategori">
                                     ...
                                     <span class="menu-arrow-white d-lg-none"></span>
                                 </span>
                             </div>
                         ...
                         <div
                             ...
                             <div onclick="window.location.href='/petugas/report-penjualan'" class="menu-item me-lg-1">
                                 <span class="menu-link py-3 keranjang">
                                     <span class="menu-title text-white sm-text-dark lg-">Data Penjualan</span>
                                     <span class="menu-arrow d-lg-none"></span>
                                 </span>
                             </div>
                             <div onclick="window.location.href='/petugas/keranjang'" class="menu-item me-lg-1">
                                 <span class="menu-link py-3 keranjang">
                                     <span class="menu-title text-white sm-text-dark lg- ">Transaksi</span>
                                     <span class="menu-arrow d-lg-none"></span>
                                 </span>
                             </div>
                         </div>
                 ...
                 <div class="d-flex align-items-center me-n3 ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                     ...
                     <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-275px"
                                 ...
                                 <div class="d-flex flex-column">
                                     <div class="fw-bolder d-flex align-items-center fs-5">{{ session('name') }}
                                         ...
                                         @if (session('user_role') == 'BfiwyVUDrXOpmStr')
                                             <span
                                                 class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Pemilik Toko</span>
                                         @else
                                             <span
                                                 class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">Petugas
                                                 Kasir</span>
                         ...
                         <div class="menu-item px-5 ">
                             <a href="/petugas/profile" class="menu-link px-5 profile">Profil</a>
                         </div>
                         <!--begin::Menu item-->
                         <div class="menu-item px-5">
