                ...
                <div id="kt_content_container" class="mt-5 d-flex flex-column-fluid align-items-start container-xxl">
                    ...
                    <div class="content flex-row-fluid" id="kt_content">
                        <div class="row gy-5 g-xl-10">
                                ...
                                <div class="card card-xl-stretch mb-xl-10"
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <div class="d-flex flex-column flex-grow-1" style="position: relative;">
                                            <a href="#" class="fw-bolder fs-3" style="color: #2E90FA;">Total
                                                Transaksi</a>
                                        </div>
                                        <div class="pt-5">

                                            <span class=" fw-bolder fs-3x me-2 lh-0" style="color: #2E90FA;">100x</span>
                            ...
                            <div class="col-xl-4">
                                <div class="card card-xl-stretch mb-xl-10"
                                    style="background-color: #2E90FA; 
									height: 183px;">
                                    <div class="card-body d-flex flex-column">
                                        <div class="d-flex flex-column flex-grow-1" style="position: relative;">
                                            <a href="#" class="text-white text-hover-primary fw-bolder fs-3">Total
                                                Kerugian</a>
                                        </div>
                                        <div class="pt-5">
