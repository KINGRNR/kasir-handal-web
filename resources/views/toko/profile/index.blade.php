                                        ...
                                        <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <a href="#"
                                                        class="text-gray-900 text-hover-primary fs-2 fw-bolder me-1 val_nama_toko">-</a>
                                                    {{-- <a href="#">
                        ...
                        <div class="card mb-5 mb-xl-10 detail-all detail-profile" id="kt_profile_details_view">
                            ...
                            <div class="card-header cursor-pointer">
                                ...
                                <a href="#" onclick="switchEditProfil(this)"
                                    class="btn btn-primary align-self-center edit-prof"
                                    style="background-color: #2E90FA">Edit Profil</a>
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="container-form" style="display: none">
                                    <form action="javascript:saveProfileToko()" method="post" id="formProfileToko"
                                        ...
                                        <div class="row mb-7">
                                            <label for="" class="col-lg-3 required text-muted form-label">Foto
                                                Produk <i>max
                                                    2mb</i></label>
                                            <div class="col-lg-5">
                                                <!--begin::Image input-->
