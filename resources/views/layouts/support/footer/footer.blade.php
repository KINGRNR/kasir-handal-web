<footer class="mt-20 relative bg-black pt-8 pb-6">
    <div class="container mt-5 mx-auto px-10">
        <div class="flex flex-wrap text-left lg:text-left">
            <div class="w-full lg:w-6/12 px-4">
                <a href="https://flowbite.com/" class="flex items-center">
                    <svg id="logo-77" width="150" height="80" viewBox="0 0 105 40" fill="white"
                        ...
                        <path class="ccustom"
                            ...
                            fill="white"></path>
                        <path class="ccustom" d="M48.1762 17.572H50.9106V3.19629H48.1762V17.572Z" fill="white"></path>
                        <path class="ccustom"
                        ...
                        <path class="ccustom"
                            ...
                            fill="white"></path>
                        <path class="ccustom" d="M88.1779 13.6313H100V11.2789H88.1779V13.6313Z" fill="white"></path>
                        <path class="ccustom"
                ...
                <h5 class="leading-loose mt-0 mb-2 mr-0 md:-mr-12 lg:-mr-20 lg-bigger:-mr-32 text-base text-white">
                ...
                <div class="mt-2 lg:mb-0 mb-6">
                    <button
                        class=" text-white hover:bg-white hover:text-black duration-100 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-4"
                        type="button">
                        <i class="fa fa-twitter fa-lg"></i></button><button
                        class="text-white hover:bg-white hover:text-black duration-100 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-4"
                        type="button">
                        <i class="fa fa-facebook-square fa-lg"></i></button><button
                        class=" text-white hover:bg-white hover:text-black duration-100 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-4"
                        type="button">
                        <i class="fa fa-quora fa-lg"></i></button><button
                        class="text-white hover:bg-white hover:text-black duration-100 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none mr-4"
                        type="button">
            ...
            <div class="w-full lg:w-6/12 px-4 pr-16">
                <div class="flex flex-wrap items-top mb-6">
                    <div class="w-full lg:w-4/12 px-4 ml-auto">
                        <span class="block uppercase text-white text-sm font-semibold mt-4 mb-6">Lorem Ipsum</span>
                        <ul class="list-unstyled">
                            <li>
                                <a class="text-white hover:text-blueGray-800 font-semibold block pb-1 mb-4 text-sm link link-underline link-underline-black"
                                    href="https://www.creative-tim.com/presentation?ref=njs-profile">Lorem Ipsum</a>
                            </li>
                            <li>
                                <a class="text-white hover:text-blueGray-800 font-semibold block pb-1 mb-4 text-sm link link-underline link-underline-black"
                                    href="https://blog.creative-tim.com?ref=njs-profile">Lorem Ipsum</a>
                            </li>
                            <li>
                                <a class="text-white hover:text-blueGray-800 font-semibold block pb-1 mb-4 text-sm link link-underline link-underline-black"
                                    href="https://www.github.com/creativetimofficial?ref=njs-profile">Lorem Ipsum</a>
                            </li>
                            <li>
                                <a class="text-white hover:text-blueGray-800 font-semibold block pb-1 mb-4 text-sm link link-underline link-underline-black"
                                    href="https://www.creative-tim.com/bootstrap-themes/free?ref=njs-profile">Lorem Ipsum</a>
                            </li>
                        </ul>
                    </div>
                    <div class="w-full lg:w-4/12 px-4">
                      <span class="block uppercase text-white text-sm font-semibold mt-4 mb-6"><i class="fa fa-address-book"></i> Kontak Bantuan</span>
                      <ul class="list-unstyled">
                          <li>
                              <a class="text-white font-semibold block pb-1 mb-4 text-sm"
                                  href="#"><i class="fa fa-street-view"></i> Jl. Bunga Indah Megah No.2, Jakarta Tenggara Indonesia</a>
                          </li>
                          <li>
                              <a class="text-white font-semibold block pb-1 mb-4 text-sm"
                                  href="#"><i class="fa fa-phone"></i> +62 8908********</a>
                          </li>
                          <li>
                              <a class="text-white font-semibold block pb-1 mb-4 text-sm "
                                  href="#"><i class="fa fa-envelope"></i> Email : LoremIpsum3221@gmail.com</a>
                          </li>
                      </ul>
                    </div>
                </div>
        ...
        <div class="flex flex-wrap items-center md:justify-between justify-center">
            <div class="w-full md:w-4/12 px-4 mx-auto text-center">
                <div class="text-xs text-white font-semibold pt-4 pb-12">
                    © <span id="get-current-year">LoremIpsum2023</span> - All Rights Reserved
                </div>
            </div>
        </div>
    </div>
