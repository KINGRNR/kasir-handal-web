<div id="kt_aside" class="aside card" data-kt-drawer="true" data-kt-drawer-name="aside"
    ...
    <div class="aside-menu flex-column-fluid">
        ...
        <div class="hover-scroll-overlay-y my-5 my-lg-6" id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="0px" style="height: 683px;">
            <!--begin::Menu-->
            <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div class="menu-item">
                    <a class="menu-link dashboard" href="/superadmin/dashboard">
                ...
                {{-- <div class="menu-item">
                    <a class="menu-link toko" href="/superadmin/toko">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <span class="menu-title">Master Toko</span>
                    </a>
                </div> --}}
                <div class="menu-item ">
                    <a class="menu-link user" href="/superadmin/user">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                ...
                <div class="menu-item">
                    <a class="menu-link superadmin" href="/superadmin/superadmin">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen025.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <span class="menu-title">Pengaturan superadmin</span>
                    </a>
                </div>
            </div>
            <!--end::Menu-->
